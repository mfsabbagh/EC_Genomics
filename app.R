...
ui <- navbarPage ( "Vascular Endothelial Cell Trans-omics Resource Database",
                   tabPanel("Home",
                            fluidPage(
                              fluidRow(
                                h1("VECTRDB"),
                                h4("We present the Vascular Endothelial Cell Trans-omics Resource Database (VECTRDB), a database that integrates and compares the transcriptional, chromatin accessibility, and DNA methylation landscapes of vascular endothelial cells (ECs). We encourage you to explore the genomic landscapes presented here using the tabs at the top of the page."),
                                br(),
                                p(strong("Transcriptional Landscape:"),"Bulk RNA-seq of postnatal day 7 (P7) vascular ECs isolated from brain, liver, lung, and kidney of Tie2-GFP transgenic mice as well as similarily isolated adult brain ECs and cultured adult brain ECs. In this tab, one can explore organ-specific EC gene expression."),
                                br(),
                                p(strong("Chromatin Accessiblity Landscape:"),"Bulk ATAC-seq of P7 vascular ECs isolated from brain, liver, lung, and kidney of Tie2-GFP transgenic mice as well as similarily isolated adult brain ECs and cultured adult brain ECs. In this tab, one can explore transcription factor binding motifs that exhibit high variability between organ-specific EC accessible chromatin."),
                                br(),
                                p(strong("CG Methylation Landscape:"),"Bulk MethylC-seq of P7 vascular ECs isolated from brain, liver, lung, and kidney of Tie2-GFP transgenic mice. In this tab, one can explore transcription factor binding motifs that exhibit high variability between organ-specific EC hypomethylated features."),
                                br(),
                                p(strong("Single-Cell RNA-seq:"),"We assessed EC gene expression in the developing CNS at single cell resolution by performing single-cell RNA-seq on 3,946 FACS-purified GFP-positive ECs from a P7 Tie2-GFP mouse brain. In this tab, one can explore gene expression in arterial, venous, capillary, mitotic, and tip subtypes of brain ECs."),
                                br(),
